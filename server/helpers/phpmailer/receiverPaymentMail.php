<?php
  ...
  function receiverPaymentMail($senderFname,$senderLname,$associationName,$senderEmail,$receiverFname,$receiverLname,$paymentIntent,$amount,$currency,$receiverEmail){
  ...
  try {
      ...
      Bonjour, '.$receiverFname.' '.$receiverLname.'
Un montant de '.$currency.' '.$amount.' a été déposé avec succès sur votre compte. de '. $senderFname.' '.$senderLname. '<br><br>
