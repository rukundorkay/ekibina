...
function invite($userEmail,$invitationlink){
...
try {
    ...
    <tr><td style="padding:10px 30px;margin:0;text-align:left;">
                ...
                <a href="' .$invitationlink.'" style="text-decoration:none;color:white;padding-right: 10px 30px;background:#3c83f9;border-top:1px solid #CCC;" >Join now</a>
