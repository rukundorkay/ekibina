        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="error-text">
                    ...
                    <h4>Oups, données non trouvées</h4>
                    <p>Désolé l'association que vous recherchez a été suspendue, veuillez nous contacter pour tout inconvénient</p>
                    <a href="./" class="btn btn-warning btn-round">Revenir à votre compte</a>
                </div>
            </div>
        </div>
    </div>
