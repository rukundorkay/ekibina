      ...
      <dsiv class="main-panel">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h3 class="d-none d-md-block">Claims</h3>
                    <h4 class="d-block d-md-none">Claims</h4>
                    <!--
       ...
       <!-- START OF DASHBOARD CARDS -->
          ...
          <div class="col-md-12 grid-margin grid-margin-md-0 ">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">List Of people who have claims.</h4>
                 ...
                 <div class="wrapper d-flex align-items-center py-2 border-bottom">
                      ...
                      <div class="wrapper ml-3 d-none d-md-block" style="border-left: 1px solid #ececea; padding-left: 10px;">
                          <h6 class="mb-1">Group</h6>
                          <small class="text-muted mb-0"><i class="fas fa-angle-right mr-1"></i>Abanyonzi Kimironko</small>
                      </div>
                    ...
                    <div class="wrapper d-flex align-items-center py-2 border-bottom">
                      ...
                      <div class="wrapper ml-3" style="border-left: 1px solid #ececea; padding-left: 10px; width: 300px;">
                          <h6 class="mb-1">Rwibutso Eldurant</h6>
                          <small class="text-muted mb-0"><i class="fas fa-spinner mr-1" style=""></i>Position 19</small>
                          <small class="text-muted mb-0"><i class="fas fa-clock mr-1"></i>23/04/2020</small>
                      </div>

                      <div class="wrapper ml-3 d-none d-md-block" style="border-left: 1px solid #ececea; padding-left: 10px;">
                          <h6 class="mb-1">Group</h6>
                          <small class="text-muted mb-0"><i class="fas fa-angle-right mr-1"></i>Impala music band</small>
                      </div>
